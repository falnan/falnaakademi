...
export default function EditStudent({ student }: any) {
    const [values, setValues] = useState({
        ...
        phone: student.phone,
        password: "",
        confirmPassword: student.users.confirmPassword,
    });
    console.log(values);
    const [error, setError]: any = useState([]);
    function handleSubmit(e: any) {
        e.preventDefault();
        router.put("/student/" + student.username, values);
    }
    ...
    return (
        <>
            <LayoutDashboard setActiveLink="Student">
                ...
                {/* form */}
                <Form title="Edit Student" onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-2 mt-5">
                        ...
                        <ButtonLink
                            link={"/student/" + student.username + "/room"}
                            bgcolor="bg-blue-500"
